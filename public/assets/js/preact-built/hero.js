(() => {
  ...
  // ns-hugo-imp:/Users/jackbinysh/Library/Caches/hugo_cache/modules/filecache/modules/pkg/mod/github.com/!hugo!blox/kit/modules/blox@v0.0.0-20260502203050-b8ad5540288a/blox/hero/component.jsx
  function renderText(text) {
    if (!text) return "";
    return String(text).replace(/\*\*(.*?)\*\*/g, "<strong>$1</strong>").replace(/\*(.*?)\*/g, "<em>$1</em>").replace(/`(.*?)`/g, "<code>$1</code>");
  }
  var HIGHLIGHT_CLS = "bg-gradient-to-r from-primary-500 via-secondary-500 to-primary-500 dark:from-primary-400 dark:via-secondary-400 dark:to-primary-400 bg-clip-text text-transparent";
  function renderTitle(text) {
    if (!text) return "";
    return String(text).replace(/\[([^\]]+)\](?!\()/g, `<span class="${HIGHLIGHT_CLS}">$1</span>`).replace(/\*\*(.*?)\*\*/g, "<strong>$1</strong>").replace(/\*(.*?)\*/g, "<em>$1</em>");
  }
  ...
  var ACTION_STYLES = {
    ...
    solid: "rounded-full bg-primary-600 px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600",
    outline: "rounded-full px-6 py-3 text-sm font-semibold ring-1 ring-inset ring-gray-300 dark:ring-gray-600 text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800/60 transition-colors",
    ghost: "rounded-full px-6 py-3 text-sm font-semibold text-gray-900 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-800/60 transition-colors",
  ...
  function ActionButton({ action, defaultStyle, iconSvg }) {
    ...
    return /* @__PURE__ */ u2("a", { href: url.href, ...url.target && { target: url.target, rel: url.rel }, class: `inline-flex items-center gap-2 ${cls}`, children: [
      /* @__PURE__ */ u2("span", { dangerouslySetInnerHTML: { __html: renderText(action.text) } }),
      iconSvg && /* @__PURE__ */ u2("span", { class: "inline-flex", children: /* @__PURE__ */ u2(Icon, { svg: iconSvg, attributes: { style: "height: 1em", class: "inline-block" } }) }),
      showTextArrow && /* @__PURE__ */ u2("span", { "aria-hidden": "true", children: "\u2192" })
    ] });
  }
  ...
  function StarStrip({ stars }) {
    const n2 = Math.max(0, Math.min(5, Number(stars) || 0));
    const full = Math.floor(n2);
    return /* @__PURE__ */ u2("div", { class: "inline-flex items-center gap-0.5 text-amber-400", children: Array.from({ length: 5 }).map((_2, i2) => /* @__PURE__ */ u2("span", { class: "w-5 h-5 inline-block", dangerouslySetInnerHTML: { __html: i2 < full ? STAR_FULL : STAR_EMPTY } }, i2)) });
  }
  function TrustStrip({ trust, alignKey = "center" }) {
    ...
    return /* @__PURE__ */ u2("div", { class: `mt-8 flex items-center ${justify} gap-3 flex-wrap`, children: [
      stars != null && /* @__PURE__ */ u2(StarStrip, { stars }),
      text && /* @__PURE__ */ u2("span", { class: "text-sm text-gray-600 dark:text-gray-400", dangerouslySetInnerHTML: { __html: renderText(text) } })
    ] });
  }
  var BADGE_COLORS = {
  ...
  function AnnouncementPill({ announcement, alignKey = "center" }) {
    ...
    return /* @__PURE__ */ u2("div", { class: `hidden sm:mb-8 sm:flex ${justify}`, children: /* @__PURE__ */ u2("div", { class: "relative flex items-center gap-2 rounded-full pl-1 pr-4 py-1 text-sm leading-6 text-gray-600 dark:text-gray-300 ring-1 ring-gray-900/10 dark:ring-gray-300/30 hover:ring-gray-900/20 dark:hover:ring-gray-300/50 transition-all", children: [
      badge?.text && /* @__PURE__ */ u2("span", { class: `rounded-full px-2.5 py-0.5 text-xs font-semibold ${badgeCls}`, children: badge.text }),
      !badge?.text && /* @__PURE__ */ u2("span", { class: "pl-2" }),
      /* @__PURE__ */ u2("span", { dangerouslySetInnerHTML: { __html: renderText(announcement.text) } }),
      announcement.link?.text && /* @__PURE__ */ u2(
        "a",
        {
  ...
  var ALIGN_TEXT = { center: "text-center", left: "text-left" };
  var ALIGN_FLEX = { center: "justify-center", left: "justify-start" };
  var ALIGN_MX = { center: "mx-auto", left: "" };
  var LAYOUTS = {
  ...
  function Media({ media, mediaImage, mediaImageDark }) {
    ...
    if (type === "video") {
      return /* @__PURE__ */ u2("div", { class: "relative", children: /* @__PURE__ */ u2(
        "video",
        {
          src: media.src,
          poster: media.poster,
    ...
    return /* @__PURE__ */ u2("div", { class: "relative", children: [
      /* @__PURE__ */ u2(
        "img",
        {
          src: mediaImage.src,
  ...
  var HeroBlock = ({ content, design, _id, icon_svg, secondary_icon_svg, media_image, media_image_dark }) => {
    ...
    const contentStack = /* @__PURE__ */ u2(S, { children: [
      /* @__PURE__ */ u2(AnnouncementPill, { announcement: content.announcement, alignKey }),
      /* @__PURE__ */ u2("div", { class: textAlign, children: [
        content.eyebrow && /* @__PURE__ */ u2(
          "p",
          {
        ...
        (content.primary_action?.url || content.secondary_action?.url) && /* @__PURE__ */ u2("div", { class: `mt-10 flex items-center ${flexAlign} gap-x-6 flex-wrap gap-y-3`, children: [
          /* @__PURE__ */ u2(ActionButton, { action: content.primary_action, defaultStyle: "gradient", iconSvg: icon_svg }),
          /* @__PURE__ */ u2(ActionButton, { action: content.secondary_action, defaultStyle: "text", iconSvg: secondary_icon_svg })
        ] }),
        /* @__PURE__ */ u2(TrustStrip, { trust: content.trust, alignKey })
      ] })
    ] });
    const mediaEl = content.media ? /* @__PURE__ */ u2(Media, { media: content.media, mediaImage: media_image, mediaImageDark: media_image_dark }) : null;
    if (layout.grid) {
      return /* @__PURE__ */ u2("div", { class: "relative isolate px-6 lg:px-8", children: /* @__PURE__ */ u2("div", { class: `mx-auto ${layout.container} ${sizeClasses}`, children: /* @__PURE__ */ u2("div", { class: "grid lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
        /* @__PURE__ */ u2("div", { class: layout.reverse ? "lg:order-2" : "", children: contentStack }),
        mediaEl && /* @__PURE__ */ u2("div", { class: layout.reverse ? "lg:order-1" : "", children: mediaEl })
      ] }) }) });
    }
    if (layout.stacked) {
      return /* @__PURE__ */ u2("div", { class: "relative isolate px-6 lg:px-8", children: /* @__PURE__ */ u2("div", { class: `mx-auto ${layout.container} ${sizeClasses}`, children: [
        /* @__PURE__ */ u2("div", { class: "mx-auto max-w-3xl", children: contentStack }),
        mediaEl && /* @__PURE__ */ u2("div", { class: "mt-16", children: mediaEl })
      ] }) });
    }
    return /* @__PURE__ */ u2("div", { class: "relative isolate px-6 lg:px-8", children: /* @__PURE__ */ u2("div", { class: `mx-auto ${layout.container} ${sizeClasses}`, children: contentStack }) });
  };
    ...
    heroBlocks.forEach((block) => {
      ...
      if (propsData) {
        try {
          ...
          R(/* @__PURE__ */ u2(HeroBlock, { ...props }), block);
